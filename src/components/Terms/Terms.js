...
function Terms() {
  return (
    <div>
      ...
      <p>
        All content on our website, including but not limited to text, graphics, logos, images, and software, is the property of eirrann.eth and is protected by United States and international copyright laws.
      </p>
      <h3>Use of Our Website</h3>
      <p>
        You may use our website for lawful purposes only. You may not use our website to transmit any content that is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, or otherwise objectionable, or that infringes our intellectual property rights or the intellectual property rights of others.
      </p>
...
//Note that the last paragraph was added and it clarifies that the limitation of liability includes direct, indirect, incidental, punitive, and consequential damages.
